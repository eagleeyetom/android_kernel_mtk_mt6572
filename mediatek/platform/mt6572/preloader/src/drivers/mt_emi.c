...
print("[EMI] EMI_DQSU = 0x%X\n", *EMI_DQSU);
print("[EMI] EMI_DQSV = 0x%X\n", *EMI_DQSV);
print("[EMI] EMI_DLLV = 0x%X\n", *EMI_DLLV);

print("[EMI] EMI_IDLA = 0x%X\n", *EMI_IDLA);
print("[EMI] EMI_IDLB = 0x%X\n", *EMI_IDLB);
print("[EMI] EMI_IDLC = 0x%X\n", *EMI_IDLC);
print("[EMI] EMI_IDLD = 0x%X\n", *EMI_IDLD);
print("[EMI] EMI_IDLE = 0x%X\n", *EMI_IDLE);
print("[EMI] EMI_IDLF = 0x%X\n", *EMI_IDLF);
print("[EMI] EMI_IDLG = 0x%X\n", *EMI_IDLG);
print("[EMI] EMI_IDLH = 0x%X\n", *EMI_IDLH);

print("[EMI] EMI_IDLI = 0x%X\n", *EMI_IDLI);
print("[EMI] EMI_IDLJ = 0x%X\n", *EMI_IDLJ);

print("[EMI] EMI_CONI = 0x%X\n", *EMI_CONI);
print("[EMI] EMI_CONJ = 0x%X\n", *EMI_CONJ);
print("[EMI] EMI_CONK = 0x%X\n", *EMI_CONK);
print("[EMI] EMI_CONL = 0x%X\n", *EMI_CONL);
print("[EMI] EMI_CONN = 0x%X\n", *EMI_CONN);
print("[EMI] EMI_GEND = 0x%X\n", *EMI_GEND);
print("[EMI] EMI_DRCT = 0x%X\n", *EMI_DRCT);

print("[EMI] EMI_DRVA = 0x%X\n", *EMI_DRVA);
print("[EMI] EMI_DRVB = 0x%X\n", *EMI_DRVB);

print("[EMI] EMI_DUTA = 0x%X\n", *EMI_DUTA);
print("[EMI] EMI_DUTB = 0x%X\n", *EMI_DUTB);
print("[EMI] EMI_DUTC = 0x%X\n", *EMI_DUTC);

print("[EMI] EMI_DUCA = 0x%X\n", *EMI_DUCA);
print("[EMI] EMI_DUCB = 0x%X\n", *EMI_DUCB);
print("[EMI] EMI_DUCE = 0x%X\n", *EMI_DUCE);
