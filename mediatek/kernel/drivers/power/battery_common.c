...
int charger_hv_detect_sw_thread_handler(void *unused)
{
    ...
    do
    {
		...
		battery_xlog_printk(BAT_LOG_CRTI, "[charger_hv_detect_sw_thread_handler] check battery before\n");
		...
		battery_xlog_printk(BAT_LOG_CRTI, "[charger_hv_detect_sw_thread_handler] check battery after\n");
